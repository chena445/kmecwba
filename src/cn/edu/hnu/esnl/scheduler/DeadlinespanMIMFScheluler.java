 ...
 * 
 */
public class DeadlinespanMIMFScheluler {
	...
	public static double scheduling(List<Application> gs, List<Processor> commomProcessorList, Integer lastTime, Integer  span) {
		...
		while (true) {
			...
			DeadlineSpanMIMFUtil.taskAllocation("DeadlineSpanMIMF调度结果",scheduledApps, commomProcessorList, currentTime, commomReadyQueue,null,span);
