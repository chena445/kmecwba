...
import cn.edu.hnu.esnl.app.yuekunchen.cost.access.alg.MECWS_AETC_I;
...
public class EX3_FFT  {
	...
	public static void test(int index,int lambda) throws IOException, ClassNotFoundException {
		...
		int cost_lower = 1; // 1h
		int cost_upper = 128; // 1h

		CompCommMartrixBean compCommMartrix = FFTGenrattor.exe(index, cost_lower, cost_upper, processor_number);
...
//			Application g1 = EHBCS.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);
//			
//			Application g2 = MECBL.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);//2018
//
//			//Application g3 = MECABP.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);
//			
//			 MECWS_AET_I.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);	 //不带补偿的-考虑平均执行时间法1/   /根据论文改动的的
//			 MECWS_AETC_I.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);    //AApro带补偿的2019
//			
//			 MECWS_REWS2023.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);	  //REWS2023
//			 //ECS.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);
//			
//			 //我们提出的算法
//			 MECWS_AET_II.exe(givenProcessorList, compMartrix, commMartrix, appCostBudget, false);	  //考虑平均执行时间法2
//			
//			MECWS_DynamicAdjust.exe(givenProce ssorList, compMartrix, commMartrix, appCostBudget, false);	  //不带补偿的
//			
//			
//			System.out.println("================================================");
			System.out.println("appMinCost:" + appMinCost + "  appMaxCost:" + appMaxCost + " appCostBudget:" + appCostBudget);
