...
//		System.out.println("============================================");
		...
		System.out.println(" MECWBA's  cost:" + DoubleUtil.format4(totalCost));
		System.out.println(" MECWBA's  energy:" + DoubleUtil.format4(totalEnergy));
		System.out.println(" MECWBA's  schedule length:" + DoubleUtil.format(sl));
		System.out.println ("");
