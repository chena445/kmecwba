 ...
 */
public class JSAPerformanceService {
	...
	public static void performance(List<Application> gs,List<Integer> criticalities, List<Processor> givenProcessorList1) {
		...
		for (Application g : gs) {
			System.out.println(g.getName()+" criticality:" + "S"+g.getCriticality()  +" makespan:" + g.getMakespan() +"    deadline:"+g.getRelativeDeadline());
		...
		System.out.println("size:" + size);
		System.out.println("S1 S2 S3 DMR:" + (double) missNumber / size);
