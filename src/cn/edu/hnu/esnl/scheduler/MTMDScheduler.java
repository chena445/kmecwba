...
import cn.edu.hnu.esnl.scheduler.utils.MTMDStaticUtil;
 ...
 *
 */
public class MTMDScheduler {

	
	public static double scheduling(List<Application> gs, List<Processor> commomProcessorList, Integer lastTime) throws IOException, ClassNotFoundException {
		...
		while (true) {
			...
			MTMDStaticUtil.taskAllocation("MTMD",scheduledApps, commomProcessorList, currentTime, commomReadyQueue,null);
