...
import cn.edu.hnu.esnl.scheduler.utils.FDWSStaticUtil;
...
public class FDWSScheduler {
	...
	public static double scheduling(List<Application> gs, List<Processor> commomProcessorList, Integer lastTime) {
		...
		while (true) {
			...
			FDWSStaticUtil.taskAllocation("��ƽ",scheduledApps, commomProcessorList, currentTime, commomReadyQueue,null);
