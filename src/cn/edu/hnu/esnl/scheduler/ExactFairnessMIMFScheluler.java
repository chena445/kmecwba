...
import cn.edu.hnu.esnl.scheduler.utils.ExactFairnessMIMFSchelulerUtil;
 ...
 *
 */
public class ExactFairnessMIMFScheluler {
	...
	public static void scheduling(List<Application> gs, List<Processor> commomProcessorList) {
		...
		ExactFairnessMIMFSchelulerUtil.taskAllocation("ExactDeadlinespanMIMFScheluler调度",gs, commomProcessorList, currentTime);
