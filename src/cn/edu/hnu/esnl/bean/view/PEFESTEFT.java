 ...
 */
public class PEFESTEFT implements Comparable<PEFESTEFT> {
	...
	public PEFESTEFT(Processor processor, Double energy, Double frequency, Double est, Double eft) {
		super();
		this.processor = processor;
		this.energy = energy;
		this.frequency = frequency;
	...
	public int compareTo(PEFESTEFT o) {
		
		return this.getEft().compareTo(o.getEft());
	}
